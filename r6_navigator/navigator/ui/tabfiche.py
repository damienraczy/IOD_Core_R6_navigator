...
from r6_navigator.navigator.ui.forms.ui_tabfiche import Ui_TabFiche
...
class _GenerateWorker(QThread):
    ...
    def run(self) -> None:
        ...
        """
        try:
            from r6_navigator.navigator.services.ai_generate import generate_fiche
...
class _GenerateRisqueWorker(QThread):
    ...
    def run(self) -> None:
        """Exécute l'appel Ollama dans le thread de fond."""
        try:
            from r6_navigator.navigator.services.ai_generate import generate_fiche_risque
...
class _JudgeWorker(QThread):
    ...
    def run(self) -> None:
        try:
            from r6_navigator.navigator.services.ai_judge import judge_fiche
