...
from r6_navigator.navigator.ui.forms.ui_tabquestions import Ui_TabQuestions
...
class _GenerateWorker(QThread):
    ...
    def run(self) -> None:
        ...
        try:
            from r6_navigator.navigator.services.ai_generate import generate_questions
...
class _GenerateItemsWorker(QThread):
    ...
    def run(self) -> None:
        """Exécute l'appel Ollama dans le thread de fond."""
        try:
            from r6_navigator.navigator.services.ai_generate import generate_questions_items
...
class _JudgeWorker(QThread):
    ...
    def run(self) -> None:
        try:
            from r6_navigator.navigator.services.ai_judge import judge_questions
