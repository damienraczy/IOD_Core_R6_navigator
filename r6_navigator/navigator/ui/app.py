...
from r6_navigator.shared.backup import restore_backup, save_backup
from r6_navigator.navigator.services.export_docx import export_bulk, export_capacity, make_filename
from r6_navigator.navigator.ui.detailpanel import DetailPanel
from r6_navigator.navigator.ui.dialogs import (
    DocxExportDialog,
    NewCapacityDialog,
    confirm,
    confirm_unsaved,
)
from r6_navigator.navigator.ui.navpanel import NavPanel
from r6_navigator.navigator.ui.tabcoaching import TabCoaching
from r6_navigator.navigator.ui.tabfiche import TabFiche
from r6_navigator.navigator.ui.tabquestions import TabQuestions
...
class R6NavigatorApp(QMainWindow):
    ...
    def __init__(self, session_factory, db_path: Path | None = None) -> None:
        ...
        self._mission_app = None  # lazily created
        self._build_ui()
        self._retranslate()
    ...
    def _retranslate(self) -> None:
        ...
        self.btn_missions.setText(t("btn.missions"))
    ...
    def _on_open_missions(self) -> None:
        """Ouvre (ou ramène au premier plan) la fenêtre du module Missions."""
        from r6_navigator.missions.ui.app import MissionApp
        if self._mission_app is None or not self._mission_app.isVisible():
            self._mission_app = MissionApp(self._session_factory, parent=None)
        self._mission_app.show()
        self._mission_app.raise_()
        self._mission_app.activateWindow()
